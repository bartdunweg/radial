...
import expertiseNl from "@/content/nl/expertise.json";
...
const content = {
  en: { blog: blogEn, work: workEn, services: servicesEn, expertise: expertiseEn, pricing: pricingEn, testimonials: testimonialsEn },
  nl: { blog: blogNl, work: workNl, services: servicesNl, expertise: expertiseNl, pricing: pricingNl, testimonials: testimonialsNl },
};
